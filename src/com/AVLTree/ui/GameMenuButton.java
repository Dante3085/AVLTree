...
public class GameMenuButton extends StackPane
{
    ...
    public void setAutoResize(boolean on)
    {
        if (on == true)
        {
            com.Main.JavaFXMain.mainWindow.widthProperty().addListener((observable, oldValue, newValue) ->
            {
                this.setTranslateX(com.Main.JavaFXMain.mainWindow.widthProperty().doubleValue() - 200);
